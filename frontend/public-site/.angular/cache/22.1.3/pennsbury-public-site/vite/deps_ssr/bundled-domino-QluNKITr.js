		...
		switch (kid.nodeType) {
			case 1:
				...
				if (!(html && emptyElements[tagname])) {
					...
					if (hasRawContent[upperTag] && !hasRawContentFallback[upperTag]) ss = escapeMatchingClosingTag(ss, tagname);
			...
			case 4:
				...
				if (hasRawContent[parenttag]) s += hasRawContentFallback[parenttag] ? escapeFallbackRawText(kid.data, parent.localName) : kid.data;
